...
public class EmpDeptSalgradeTests
{
    ...
    public void ShouldReturnEmployeesFromChicago()
    {
        ...
        List<Emp> result = emps.Where(e => depts.Where(d => d.Loc=="CHICAGO").Select(d=> d.DeptNo).Contains(e.EmpNo)).ToList(); 
    ...
    public void ShouldMatchEmployeeToSalaryGrade()
    {
        ...
        var grades = Database.GetSalgrades();
         ...
         var result = emps
             .Select(e => new 
             { 
                 e.EName, grades.FirstOrDefault(s => e.Sal >= s.Losal && e.Sal <= s.Hisal)?.Grade 
             })
