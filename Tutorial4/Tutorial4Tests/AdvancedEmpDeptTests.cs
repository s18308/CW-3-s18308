...
public class AdvancedEmpDeptTests
{
    ...
    public void ShouldFindAnyWithCommissionOver400()
    {
        ...
        var result = emps.Where(e => e.Sal>400).ToList(); 
        
        Assert.Contains(result, e => e.Sal>400);
    }
    ...
    public void ShouldReturnEmployeeManagerPairs()
    {
        ...
        var result = emps
            ...
            {
                Employee = e.EName,
                Manager = emps.FirstOrDefault(m => m.EmpNo == e.Mgr)?.EName
            })
            .ToList();
    ...
    public void ShouldJoinEmpDeptSalgrade()
    {
        ...
        var result = emps
            .Join(grades,
                ...
                sal => true,
                (emp, sal) => new { emp, sal })
            .Where(obj => obj.emp.Sal >= obj.sal.Losal && obj.emp.Sal <= obj.sal.Hisal)
            .Join(depts,
                obj => obj.emp.DeptNo,
                dept => dept.DeptNo,
